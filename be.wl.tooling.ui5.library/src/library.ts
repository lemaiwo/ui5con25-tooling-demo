...
/**
 * Initialization Code and shared classes of library be.wl.tooling.ui5.library.
 */
...
const thisLib: { [key: string]: unknown } = Lib.init({
	...
	types: ["be.wl.tooling.ui5.library.ExampleColor"],
	interfaces: [],
	controls: ["be.wl.tooling.ui5.library.Example"],
	elements: [],
